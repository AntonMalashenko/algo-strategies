...
DUKA_NAME = "GER40_Dukascopy_M1_2023-06-26_2026-08-11.csv.gz"  # refreshed 2026-08-11 via dukascopy-node (deuidxeur) for ALGODEV-21 (liquidity_tp_floor) validation; see decisions-log.md
